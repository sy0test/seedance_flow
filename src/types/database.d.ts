// @db-hash 9b280da5067cb450bdbc2fea24101a10
//该文件由脚本自动生成，请勿手动修改
...
export interface seedance_asset_ref_map {
  'assetId'?: number | null;
  'assetName': string;
...
export interface seedance_episode {
  'createdAt'?: number | null;
  'episodeKey': string;
  'id'?: number;
  'projectId': number;
...
export interface seedance_output {
...
export interface seedance_project {
  'createdAt'?: number | null;
  'directorVersion'?: string | null;
  'id'?: number;
  'projectId': number;
...
export interface DB {
  ...
  "seedance_asset_ref_map": seedance_asset_ref_map;
  "seedance_episode": seedance_episode;
  "seedance_output": seedance_output;
  "seedance_project": seedance_project;
}
