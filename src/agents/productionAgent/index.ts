...
export async function runDecisionAI(ctx: AgentContext) {
  ...
  const skill = path.join(u.getPath(["skills", "director"]), "production_agent_decision.md");
...
async function createSubAgent(parentCtx: AgentContext) {
  ...
  //     const skill = path.join(u.getPath(["skills", "director"]), "production_agent_execution.md");
  ...
  const run_sub_agent_derive_assets = tool({
    ...
    execute: async ({ prompt }) => {
      const skill = path.join(u.getPath(["skills", "director"]), "production_execution_derive_assets.md");
      const systemPrompt = await fs.promises.readFile(skill, "utf-8");
      return runAgent({
  ...
  const run_sub_agent_generate_assets = tool({
    ...
    inputSchema: jsonSchema<{ prompt: string }>(promptInput),
    execute: async ({ prompt }) => {
      const skill = path.join(u.getPath(["skills", "director"]), "production_execution_generate_assets.md");
      const systemPrompt = await fs.promises.readFile(skill, "utf-8");
      return runAgent({
  ...
  const run_sub_agent_director_plan = tool({
    ...
    inputSchema: jsonSchema<{ prompt: string }>(promptInput),
    execute: async ({ prompt }) => {
      const skill = path.join(u.getPath(["skills", "director"]), "production_execution_director_plan.md");
      const systemPrompt = await fs.promises.readFile(skill, "utf-8");
  ...
  const run_sub_agent_storyboard_gen = tool({
    ...
    inputSchema: jsonSchema<{ prompt: string }>(promptInput),
    execute: async ({ prompt }) => {
      const skill = path.join(u.getPath(["skills", "director"]), "production_execution_storyboard_gen.md");
      const systemPrompt = await fs.promises.readFile(skill, "utf-8");
      return runAgent({
  ...
  const run_sub_agent_storyboard_panel = tool({
    ...
    inputSchema: jsonSchema<{ prompt: string }>(promptInput),
    execute: async ({ prompt }) => {
      const skill = path.join(u.getPath(["skills", "director"]), "production_execution_storyboard_panel.md");
      const systemPrompt = await fs.promises.readFile(skill, "utf-8");
  ...
  const run_sub_agent_storyboard_table = tool({
    ...
    inputSchema: jsonSchema<{ prompt: string }>(promptInput),
    execute: async ({ prompt }) => {
      const skill = path.join(u.getPath(["skills", "director"]), "production_execution_storyboard_table.md");
      const systemPrompt = await fs.promises.readFile(skill, "utf-8");
  ...
  const run_sub_agent_supervision = tool({
    ...
    inputSchema: jsonSchema<{ prompt: string }>(promptInput),
    execute: async ({ prompt }) => {
      const skill = path.join(u.getPath(["skills", "director"]), "production_agent_supervision.md");
      const systemPrompt = await fs.promises.readFile(skill, "utf-8");
      return runAgent({
...
async function createArtSkills(artName: string, storyName: string) {
  const artWorkerPath = u.getPath(["skills", "director", "art_skills", artName, "driector_skills"]);
  const storyWorkerPath = u.getPath(["skills", "director", "story_skills", storyName, "driector_skills"]);
...
async function useProductionSkills(artName: string, storyName: string) {
  const artWorkerPath = u.getPath(["skills", "director", "art_skills", artName, "driector_skills"]);
  const storyWorkerPath = u.getPath(["skills", "director", "story_skills", storyName, "driector_skills"]);
  const productionPath = u.getPath(["skills", "director", "production_skills"]);
  const skillList = [
